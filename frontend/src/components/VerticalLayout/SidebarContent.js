      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                  <Link to="/dashboard">{props.t("Tableau de bord")}</Link>
                </li>
            {
              curUser?.role==='admin' && <>
            <li>
              <Link to="/listeEmployer">{props.t("Liste des employers")}</Link>
            </li>
            <li>
              <Link to="/listeManager">{props.t("Liste des managers")}</Link>
            </li>
            <li>
              <Link to="/listeConge">{props.t("Liste des conges")}</Link>
            </li>
            <li>
              <Link to="/listeJour">{props.t("Liste des jours ")}</Link>
            </li>
            <li>
              <Link to="/listSolde">{props.t("Liste des soldes ")}</Link>
            </li>
            <li>
              <Link to="/listDemande">{props.t("Liste des Demandes ")}</Link>
            </li>
            <li>
              <Link to="/listDemandeMa">{props.t("Liste des Demande manager ")}</Link>
            </li>
            <li>
              <Link to="/listDepartement">{props.t("Liste des Departements ")}</Link>
            </li>
            <li>
              <Link to="/listEtablissement">{props.t("Liste des Etablissements ")}</Link>
            </li>
            <li>
              <Link to="/listCarriere">{props.t("Liste des Carrieres ")}</Link>
            </li>
              </>
            }
            ...
            <li>
              <Link to="/listDemandeMa">{props.t("Liste des Demande ")}</Link>
            </li>
              
            <li>
              <Link to="/listeUser">{props.t("Liste des emplyers")}</Link>
            </li>
            {/* <li>
            <Link to="/listSolde">{props.t("Liste des solde ")}</Link>
            </li> */}
              </>
            }
            {
            ...
            <li>
              <Link to="/listDemandeMy">{props.t("Mes Demande ")}</Link>
            </li>
              </>
            }
          ...
          {/* <ul>  
            ...
            <li>
              <Link to="/demande1">{props.t("Demande de congé")}</Link>
            </li>
            <li>
              <Link to="/ajoutEmploye">{props.t("Ajouter un employé")}</Link>
            </li>
            <li>
              <Link to="/ListeDemandeConge">
                {props.t("ListeDemandeConge")}
              </Link>
            </li>
            <li>
              <Link to="/#" className="">
