...
import { addUser, currentUser, deleteuser, getalluser, getmanagers, updateuser } from "store/user/user_action"
...
const ManagerList = props => {
  ...
  const users = useSelector(state => state.User_reducer.listManager).reverse()
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        ...
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Liste" breadcrumbItem="manager" />
          <Row>
            <Col lg="12">
              <Card>
                <CardBody>
